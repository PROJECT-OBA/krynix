...
/** The TraceEvent JSON Schema (draft-07). */
export const traceEventSchema = TRACE_SCHEMA;

/** The Policy JSON Schema (draft-07). */
export const policySchema = POLICY_SCHEMA;

/** The EvaluationResult (report) JSON Schema (draft-07). */
export const reportSchema = REPORT_SCHEMA;
